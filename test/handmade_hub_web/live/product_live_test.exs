defmodule HandmadeHubWeb.ProductLiveTest do
  use HandmadeHubWeb.ConnCase

  import Phoenix.LiveViewTest
  import HandmadeHub.CatalogFixtures

  @create_attrs %{name: "some name", description: "some description", image: "some image", price: "120.5", quantity: 42}
  @update_attrs %{name: "some updated name", description: "some updated description", image: "some updated image", price: "456.7", quantity: 43}
  @invalid_attrs %{name: nil, description: nil, image: nil, price: nil, quantity: nil}
