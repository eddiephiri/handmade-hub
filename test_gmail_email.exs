...
# Run with: mix run test_gmail_email.exs

IO.puts("🧪 Testing Gmail email delivery to eddiephiri44@gmail.com...")
...
if gmail_username && gmail_password do
  ...
  IO.puts("📝 Example:")
  IO.puts("   export GMAIL_USERNAME=\"eddiephiri44@gmail.com\"")
  IO.puts("   export GMAIL_APP_PASSWORD=\"your-16-character-app-password\"")
  System.halt(1)
end
