defmodule HandmadeHubWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule HandmadeHubWeb.PageLive do
  ...
  Or use the `live_session` of your router to invoke the on_mount callback:
      ...
      live_session :authenticated, on_mount: [{HandmadeHubWeb.UserAuth, :ensure_authenticated}] do
