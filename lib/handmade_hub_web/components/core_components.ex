defmodule HandmadeHubWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: HandmadeHubWeb.Gettext
    ...
    <div>
      ...
      <%= if @type == "password" do %>
        <input
          ...
          class={
            ("mt-2 block w-full rounded-md border bg-white shadow-sm text-zinc-900 focus:ring-0 sm:text-sm sm:leading-6 " <>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HandmadeHubWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HandmadeHubWeb.Gettext, "errors", msg, opts)
    end
  end
