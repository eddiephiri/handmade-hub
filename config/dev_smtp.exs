# Development configuration with SMTP email delivery
...
# Configure the mailer to use SMTP instead of local storage
config :handmade_hub, HandmadeHub.Mailer,
  adapter: Swoosh.Adapters.SMTP,
  relay: "smtp.gmail.com",
  port: 587,
  username: "eddiephiri44@gmail.com",  # Your Gmail address
  password: "YOUR_16_CHAR_APP_PASSWORD",  # Replace with your Gmail app password
  tls: :always,
  auth: :always,
  retries: 2,
  no_mx_lookups: false
